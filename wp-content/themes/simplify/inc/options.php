...
function optionsframework_options() {
	...
	$options[] = array(
		'desc' => '<div class="infohead"><span class="donation">'. __('A Theme is an effort of many sleepless nights of Developers. You can contribute on this development translating this theme in your Language. You can send your translation/language file to us, ','simplify').' <a href="http://d5creation.com/contact/" target="_blank"><strong>'. __('Contact Us.','simplify') .'</a> '. __('You can inspire us writing a ','simplify').'<a href="http://wordpress.org/support/view/theme-reviews/simplify" target="_blank">'.__('Positive Review','simplify').'</a> '.__('of our Theme.','simplify').'</span><br /><br /><span class="donation"> '. __('Need More Features and Options including Exciting 3D Slide, Unlimited Slides with any of 04 Effects, Unlimited Featured Boxes, Color Changing Option, Easy Translation Option and 100+ Advanced Features? Try','simplify').' <a href="http://d5creation.com/theme/simplify/" target="_blank"><strong>SIMPLIFY Extend</strong></a>.</span><br /> <br /><span class="donation"> '. __('You can Visit the SIMPLIFY Extend Demo ','simplify').' <a href="http://demo.d5creation.com/themes/?theme=Simplify" target="_blank"><strong>'. __('Here','simplify').'</strong></a>.</span><a href="http://d5creation.com/theme/simplify/" target="_blank" class="extendlink"> </a></div>',
		'type' => 'info');
